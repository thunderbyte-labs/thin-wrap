...
- **Session Logging:** Conversations auto-saved as `.toml.zip` with metadata (message count, preview). Reload with `/reload`; name the current conversation with `/nameconv` (shown in the reload list).
